================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: LedDirJudge プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した LedDirJudge には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには LedDirJudge アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
LedDirJudge.h
   ...
   CLedDirJudgeApp アプリケーション クラスを宣言します。

LedDirJudge.cpp
   これは、アプリケーション クラス CLedDirJudgeApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\LedDirJudge.ico
   ...
   アイコンはメイン リソース ファイル LedDirJudge.rc に含まれていま
   す。
...
LedDirJudgeDlg.h, LedDirJudgeDlg.cpp - ダイアログ
   これらのファイルは CLedDirJudgeDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な LedDirJudge.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   LedDirJudge.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
